...
// Relations
export const mediaItemRelations = relations(mediaItems, ({ many }) => ({
...
export const mediaItemTagRelations = relations(mediaItemTags, ({ one }) => ({
...
export const mediaItemCategoryRelations = relations(mediaItemCategories, ({ one }) => ({
  mediaItem: one(mediaItems, {
